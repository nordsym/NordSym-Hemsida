...
const NordSymLang = {
  ...
  translations: {
    sv: {
      ...
      rndSubtitle: 'Geometrin uppdateras i realtid av AI-agenter. Det du ser är vad som händer just nu.',
    ...
    en: {
      ...
      rndSubtitle: 'The geometry is updated in real-time by AI agents. What you see is what is happening right now.',
